...
export const dict = {
  ...
  "settings.general.row.showToolCalls.title": "Araç çağrılarını göster",
  "settings.general.row.showToolCalls.description": "Zaman çizelgesinde araç çağrılarını görüntüle",
