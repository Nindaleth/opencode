export const dict = {
  ...
  "settings.general.row.showToolCalls.title": "Показывать вызовы инструментов",
  "settings.general.row.showToolCalls.description": "Отображать вызовы инструментов в ленте",
