export const dict = {
  ...
  "settings.general.row.showToolCalls.title": "Pokaż wywołania narzędzi",
  "settings.general.row.showToolCalls.description": "Wyświetlaj wywołania narzędzi na osi czasu",
