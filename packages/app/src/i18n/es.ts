export const dict = {
  ...
  "settings.general.row.showToolCalls.title": "Mostrar llamadas a herramientas",
  "settings.general.row.showToolCalls.description": "Mostrar llamadas a herramientas en la línea de tiempo",
