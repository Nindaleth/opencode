export const dict = {
  ...
  "settings.general.row.showToolCalls.title": "Afficher les appels d'outils",
  "settings.general.row.showToolCalls.description": "Afficher les appels d'outils dans la chronologie",
